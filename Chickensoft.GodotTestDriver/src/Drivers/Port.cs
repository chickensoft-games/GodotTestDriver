...
public readonly struct Port
{
  ...
  /// <summary>
  /// The default value of this is false, so if you do a Port foo = default you
  /// will get an undefined port id.
  /// </summary>
  ...
  public static Port Input(int port) => new(port, true);
  ...
  /// <param name="port">Port index.</param>
  /// <returns>A new port instance.</returns>
  public static Port Output(int port) => new(port, false);
  ...
  public override string ToString() =>
    IsInput
      ? $"Input Port {PortIndex}"
      : $"Output Port {PortIndex}";
}
