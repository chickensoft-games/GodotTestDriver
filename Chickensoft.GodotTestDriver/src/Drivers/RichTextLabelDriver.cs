...
public class RichTextLabelDriver<T> : ControlDriver<T> where T : RichTextLabel
{
  ...
  /// </summary>
  /// <param name="producer">
  /// Producer that creates a RichTextLabel subclass.
  /// </param>
  /// <param name="description">Driver description.</param>
  public RichTextLabelDriver(Func<T> producer, string description = "")
...
public sealed class RichTextLabelDriver : RichTextLabelDriver<RichTextLabel>
{
  ...
  /// </param>
  /// <param name="description">Driver description.</param>
  public RichTextLabelDriver(
    Func<RichTextLabel> producer,
    string description = ""
  )
    : base(producer, description)
  {
