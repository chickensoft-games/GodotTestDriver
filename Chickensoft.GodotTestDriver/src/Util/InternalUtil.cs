...
internal static class InternalUtil
{
  ...
  public static SignalAwaiter SleepSeconds(this Node source, float sleepTime) =>
    source.ToSignal(
      source.GetTree().CreateTimer(sleepTime),
  ...
  public static Rect2 ToGlobalRect(
    this Rect2 localRect,
    Vector2 globalPosition
  ) =>
    new(globalPosition + localRect.Position, localRect.Size);
  ...
  public static Vector2 WorldToScreen(
    ...
    viewport.CanvasTransform * worldPosition;
  ...
  public static Vector2 ScreenToWorld(
    ...
    screenPosition * viewport.CanvasTransform;
  ...
  public static Rect2 WorldToScreen(this Viewport viewport, Rect2 worldRect) =>
    viewport.CanvasTransform * worldRect;
  ...
  public static Rect2 ScreenToWorld(this Viewport viewport, Rect2 screenRect) =>
    screenRect * viewport.CanvasTransform;
}
