...
{
  /// <summary>
  /// Holds a controller axis at a given position for a given period of time
  /// before releasing it, causing <see cref="InputEventJoypadMotion"/> events
  /// to fire at an appropriate interval.
  /// </summary>
  /// <remarks>
  /// Does not affect the values of
  /// <see cref="Input.IsActionPressed(StringName, bool)"/>,
  /// <see cref="Input.GetJoyAxis(int, JoyAxis)"/>, or
  /// <see cref="Input.GetActionStrength(StringName, bool)"/>.
  /// </remarks>
  ...
  public static async Task HoldJoypadAxisFor(
    this Node node,
    float seconds,
    JoyAxis axis,
    float axisValue,
  ...
  /// <summary>
  /// Holds a controller button down for a given period of time before releasing
  /// it, causing <see cref="InputEventJoypadButton"/> events to fire at an
  /// appropriate interval.
  /// </summary>
  /// <remarks>
  /// Does not affect the value of
  /// <see cref="Input.IsActionPressed(StringName, bool)"/> or
  /// <see cref="Input.IsJoyButtonPressed(int, JoyButton)"/>.
  /// </remarks>
  /// <param name="node">Node that generates simulated input.</param>
  /// <param name="seconds">Input duration, in seconds.</param>
  ...
  /// Asynchronous task completed when the button is released.
  /// </returns>
  public static async Task HoldJoypadButtonFor(
    this Node node,
    float seconds,
  ...
  /// <see cref="InputEventJoypadButton"/> events to fire.
  /// </summary>
  /// <remarks>
  /// Does not affect the value of
  /// <see cref="Input.IsActionPressed(StringName, bool)"/> or
  ...
  /// <param name="buttonIndex">Button that will be pressed.</param>
  /// <param name="device">Input device that is the source of the event.</param>
  public static void TapJoypadButton(
    this Node node,
    JoyButton buttonIndex,
    int device = 0
  )
  ...
  /// </summary>
  /// <remarks>
  /// Although the full valid range of <paramref name="axisValue"/> is -1.0f to
  /// 1.0f, some controller axes (e.g., gamepad triggers) only generate values
  /// between 0.0f and 1.0f. Does not affect the values of
  /// <see cref="Input.IsActionPressed(StringName, bool)"/>,
  /// <see cref="Input.GetJoyAxis(int, JoyAxis)"/>, or
  /// <see cref="Input.GetActionStrength(StringName, bool)"/>.
  /// </remarks>
  ...
  /// </param>
  /// <param name="device">Input device that is the source of the event.</param>
  public static void MoveJoypadAxisTo(
    this Node _,
    JoyAxis axis,
    float axisValue,
    int device = 0
  ...
  /// </summary>
  /// <remarks>
  /// Equivalent to <c>node.MoveJoypadAxisTo(axis, 0.0f, device)</c>. Does not
  ...
  /// <param name="device">Input device that is the source of the event.</param>
  /// <seealso cref="MoveJoypadAxisTo(Node, JoyAxis, float, int)"/>
  public static void ReleaseJoypadAxis(
    this Node node,
    JoyAxis axis,
    int device = 0
  ) =>
  ...
  /// <summary>
  /// Presses a controller button, causing an
  /// <see cref="InputEventJoypadButton"/> to fire.
  /// </summary>
  /// <remarks>
  /// Does not affect the values of
  /// <see cref="Input.IsActionPressed(StringName, bool)"/> or
  ...
  /// <param name="buttonIndex">Button that will be pressed.</param>
  /// <param name="device">Input device that is the source of the event.</param>
  public static void PressJoypadButton(
    this Node _,
    JoyButton buttonIndex,
    int device = 0
  )
  ...
  /// <summary>
  /// Releases a controller button, causing an
  /// <see cref="InputEventJoypadButton"/> to fire.
  /// </summary>
  /// <remarks>
  /// Does not affect the values of
  ...
  /// <param name="device">Input device that is the source of the event.</param>
  public static void ReleaseJoypadButton(
    this Node _,
    JoyButton buttonIndex,
    int device = 0
  )
