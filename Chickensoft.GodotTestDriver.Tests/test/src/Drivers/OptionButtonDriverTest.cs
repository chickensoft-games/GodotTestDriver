...
public class OptionButtonDriverTest : DriverTest
{
  ...
  {
    _optionButton = new OptionButtonDriver(
      () => RootNode.GetNode<OptionButton>("OptionButton")
    );
  }
  ...
  public void SelectingAnItemWorks()
  {
    ...
    var signalAwaiter = _optionButton.GetSignalAwaiter(
  ...
  public void SelectingANonExistingItemThrowsException()
  {
    ...
    var exception = Should.Throw<Exception>(
      () => _optionButton.SelectItemWithText("Non-existing Item")
    );
  ...
  public void SelectingADisabledItemThrowsException()
  {
    ...
    var exception = Should.Throw<Exception>(
      () => _optionButton.SelectItemWithText("Disabled Item")
    );
  ...
  public void SelectingASeparatorThrowsException()
  {
    ...
    var exception = Should.Throw<Exception>(
      () => _optionButton.SelectItemWithText("Separator")
    );
