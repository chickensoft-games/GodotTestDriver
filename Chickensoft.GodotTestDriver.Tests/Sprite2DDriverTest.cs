...
public class Sprite2DDriverTest : DriverTest
{
    ...
    {
        _sprite2D = new Sprite2DDriver(() => RootNode.GetNode<Sprite2D>("Sprite2D"));
        _partiallyVisibleSprite2D = new Sprite2DDriver(() => RootNode.GetNode<Sprite2D>("PartiallyVisibleSprite2D"));
    }
